...
Setting('CURRENCY', 'HKD');

// Feature flags
// Set to true to enable the corresponding feature
Setting('FEATURE_FLAG_CUSTOM_CSS', true); // a custom CSS file, see /data/custom.css
Setting('FEATURE_FLAG_CUSTOM_JS', true);  // a custom JS file, see /data/custom.js
...
Setting('BASE_URL', 'http://localhost/grocy/public');
